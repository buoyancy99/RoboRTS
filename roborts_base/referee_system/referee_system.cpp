...
namespace roborts_base {
    ...
    void RefereeSystem::ROS_Init() {
        ...
        //ros subscriber
        ros_sub_projectile_supply_ = ros_nh_.subscribe("projectile_supply", 1, &RefereeSystem::ProjectileSupplyCallback,
                                                       this);
    ...
    void
    RefereeSystem::RobotStatusCallback(const std::shared_ptr <roborts_sdk::cmd_game_robot_state> raw_robot_status) {
