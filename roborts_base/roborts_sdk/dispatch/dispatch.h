...
namespace roborts_sdk {
    ...
    public:
        ...
        SharedFuture AsyncSendRequest(SharedRequest request, CallbackType &&cb) {
            ...
            bool ret = GetHandle()->GetProtocol()->SendRequest(GetCommandInfo().get(), request_header.get(),
                                                               request.get());
            ...
            //TODO: Determine key: seq_num or session_id
            pending_requests_[request_header->session_id] = std::make_tuple(call_promise,
                                                                            std::forward<CallbackType>(cb), f);
    ...
    public:
        ...
        void SendResponse(
            ...
            bool ret = GetHandle()->GetProtocol()->SendResponse(GetCommandInfo().get(), request_header.get(),
                                                                response.get());
